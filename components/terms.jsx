...
export default function Terms(){
  ...
  const sections=[
    ...
    ["Contact","For questions about these Terms, contact us at legal@thenitro.ng"],
  ];

  return <LegalPage dark={dark} t={t} toggleTheme={toggleTheme} label="Legal" title="Terms of" titleAccent="Service" date="March 23, 2026" sections={sections} emailField="legal@thenitro.ng" relatedLinks={[["Privacy Policy","/privacy"],["Refund Policy","/refund"],["Cookie Policy","/cookie"]]}/>;
}
    ...
    <div style={{minHeight:"100dvh",background:t.bg,fontFamily:"'Outfit',system-ui,sans-serif",transition:"background .5s ease",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{flex:1,maxWidth:780,margin:"0 auto",width:"100%",padding:"48px 24px 60px"}}>
        <div style={{marginBottom:40}}>
          ...
          <h1 style={{fontSize:"clamp(32px,5vw,44px)",fontWeight:800,color:t.text,letterSpacing:-.5,lineHeight:1.1,marginBottom:8}}>
            {title} <span className="serif" style={{fontWeight:400,fontStyle:"italic",color:t.accent,fontSize:"clamp(36px,5.5vw,50px)"}}>{titleAccent}</span>
          </h1>
