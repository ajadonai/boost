        ...
        <aside className="dash-left" style={{ background: t.sidebarBg, borderRight: `0.5px solid ${t.sidebarBorder}`, left: leftOpen ? 0 : undefined }}>
          ...
          <div className="dash-sidebar-social">
            <div className="dash-social-btns">
              ...
              {socialLinks.social_whatsapp_support && <a href={`https://wa.me/${socialLinks.social_whatsapp_support.replace(/\D/g,"")}`} target="_blank" rel="noopener noreferrer" className="dash-social-btn dash-social-wa" title="WhatsApp">
              ...
              {socialLinks.social_telegram_support && <a href={`https://t.me/${socialLinks.social_telegram_support.replace(/^(https?:\/\/)?(t\.me\/)?@?/,"")}`} target="_blank" rel="noopener noreferrer" className="dash-social-btn dash-social-tg" title="Telegram">
