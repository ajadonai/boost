  ...
  return(
    <div className="root" suppressHydrationWarning style={{height:"100dvh",overflow:"hidden",display:"flex",flexDirection:"column"}}>
      <style suppressHydrationWarning>{`
        ...
        @media(max-width:1024px){.hero-split{flex-direction:column;gap:24px;padding:36px 36px 28px;text-align:center}.hero-left{text-align:center}.hero-right{display:none}.hero-mobile-cta{display:flex;justify-content:center;margin-top:28px}.hero-left .fd4:not(.hero-mobile-cta){display:none!important}.hero-stats{justify-content:center!important}.hero-h1{font-size:54px!important}.hero-refined{font-size:60px!important}.hero-sub{font-size:18px!important;max-width:520px!important;margin-left:auto!important;margin-right:auto!important}.hero-stat-val{font-size:24px!important}.hero-stat-icon{font-size:18px!important}.hero-stat-label{font-size:12px!important}.hero-badge{font-size:14px!important}.hero-stats{gap:40px!important}.nav-links{display:none!important}.nav-login{display:inline-flex!important}}
