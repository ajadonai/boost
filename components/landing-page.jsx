  ...
  return(
    <div className="root" suppressHydrationWarning style={{height:"100dvh",overflow:"hidden",display:"flex",flexDirection:"column"}}>
      <style suppressHydrationWarning>{`
        ...
        @media(max-width:1024px){.hero-split{flex-direction:column;gap:24px;padding:36px 36px 28px;text-align:center}.hero-left{text-align:center}.hero-right{display:none}.hero-mobile-cta{display:flex;justify-content:center;margin-top:28px}.hero-left .fd4:not(.hero-mobile-cta){display:none!important}.hero-stats{justify-content:center!important}.hero-h1{font-size:52px!important}.hero-refined{font-size:58px!important}.hero-sub{font-size:17px!important;max-width:500px!important;margin-left:auto!important;margin-right:auto!important}.hero-stat-val{font-size:22px!important}.hero-badge{font-size:13px!important}.nav-links{display:none!important}.nav-login{display:inline-flex!important}}
