  ...
  return(
    <div className="root" suppressHydrationWarning style={{height:"100dvh",overflow:"hidden",display:"flex",flexDirection:"column"}}>
      <style suppressHydrationWarning>{`
        ...
        .hero-h1{font-size:60px}.hero-refined{font-size:68px}.hero-sub{font-size:17px}.hero-badge{font-size:13px}.hero-stat-val{font-size:22px}.hero-stat-icon{font-size:16px}.hero-stat-label{font-size:12px}
        ...
        @media(max-width:1199px){.hero-split{flex-direction:column;gap:24px;padding:36px 28px 28px;text-align:center}.hero-left{text-align:center}.hero-right{display:none}.hero-mobile-cta{display:flex;justify-content:center;margin-top:28px}.hero-left .fd4:not(.hero-mobile-cta){display:none!important}.hero-stats{justify-content:center!important}.hero-h1{font-size:54px!important}.hero-refined{font-size:60px!important}.hero-sub{font-size:18px!important;max-width:520px!important;margin-left:auto!important;margin-right:auto!important}.hero-stat-val{font-size:24px!important}.hero-stat-icon{font-size:18px!important}.hero-stat-label{font-size:12px!important}.hero-badge{font-size:14px!important}.hero-stats{gap:40px!important}.nav-links{display:none!important}.main-nav{padding:0 28px!important}}
        @media(max-width:767px){.main-nav{padding:0 20px!important;height:52px!important}.main-nav button:first-child{gap:8px!important}.main-nav button:first-child span{font-size:15px!important}.main-nav button:first-child div:first-child{width:26px!important;height:26px!important;border-radius:7px!important}.hero-split{padding:24px 20px 20px;gap:20px}.hero-mobile-cta button{padding:16px 48px!important;font-size:16px!important;border-radius:16px!important}.hero-h1{font-size:42px!important}.hero-refined{font-size:48px!important}.hero-sub{font-size:16px!important;margin-bottom:24px!important;max-width:340px!important;margin-left:auto!important;margin-right:auto!important}.hero-badge{font-size:13px!important;margin-bottom:20px!important;padding:5px 16px!important}.hero-stats{gap:32px!important}.hero-stat-val{font-size:22px!important}.hero-stat-icon{font-size:16px!important}.hero-stat-label{font-size:11px!important}.hero-carousel-item{padding:8px 16px!important;font-size:13px!important;border-radius:10px!important;gap:6px!important}}
        ...
        .pricing-sec{min-height:calc(100dvh - 100px);display:flex;flex-direction:column;position:relative;background:${dark?"#060810":"#1a1520"};overflow:hidden}
        ...
        .sec{min-height:calc(100dvh - 100px);display:flex;flex-direction:column;justify-content:center;position:relative}
        @media(max-width:1024px){.sec{min-height:calc(100dvh - 100px)}.hero-stats{gap:36px!important}.hero-content{padding:20px 32px!important}.hero-badge{font-size:13px!important;margin-bottom:22px!important}.hero-h1{font-size:46px!important}.hero-refined{font-size:52px!important}.hero-sub{font-size:16px!important;max-width:400px!important;margin-bottom:30px!important}.hero-btns .hero-btn{padding:14px 32px!important;font-size:15px!important}.hero-stat-val{font-size:20px!important}.hero-carousel-item{padding:8px 16px!important;font-size:13px!important}.s2-features{grid-template-columns:1fr 1fr!important;gap:12px!important}.s2-features .feat{padding:20px 18px!important;border-radius:16px!important}.feat-ic{width:40px!important;height:40px!important;min-width:40px!important;min-height:40px!important;font-size:19px!important}.feat-desc{font-size:12px!important}.s2-features .feat h3{font-size:15px!important}.feat-row{gap:12px!important}.s2-wrap{padding:32px 0 24px!important}.s2-steps-wrap{padding:24px 0 36px!important}.s2-wrap h2{font-size:28px!important}.s2-wrap h2 .serif{font-size:32px!important}.s2-steps-wrap h2{font-size:24px!important}.s2-step-icon{width:48px!important;height:48px!important;border-radius:14px!important}.s2-step-text{font-size:11px!important}.nav-links{display:none!important}.pricing-sec{min-height:auto}.pricing-content{padding:32px!important}.pricing-header{margin-bottom:32px}.pricing-title{font-size:34px!important}.pricing-title-accent{font-size:38px!important}.pricing-sub{font-size:14px!important}.pricing-cards{gap:16px!important}.pc{padding:24px 20px!important}.pc-pop{padding:26px 22px!important}.pc-icon{width:40px!important;height:40px!important;border-radius:11px!important}.pc-name{font-size:16px!important}.pc-svc{font-size:13px!important}.pc-price{font-size:13px!important}.pc-btn{padding:11px 0!important;margin-top:16px!important}.pricing-note{font-size:12px!important}.pricing-glow-center{width:400px!important;height:400px!important}.footer-inner{padding:40px 24px 18px!important}.footer-top{gap:32px!important;margin-bottom:32px!important}.footer-links{gap:36px!important}.footer-brand{max-width:240px!important}.footer-brand-desc{font-size:12px!important}.auth-card{max-width:420px!important;height:540px!important;padding:24px 26px!important;border-radius:18px!important}.auth-card h2{font-size:20px!important;margin-bottom:2px!important}.auth-card p{font-size:12px!important;margin-bottom:18px!important}.auth-card input{padding:10px 12px!important;font-size:13px!important;border-radius:10px!important;margin-bottom:6px!important}.auth-card button{font-size:13px!important;padding:12px 0!important}.auth-card label{font-size:10px!important;margin-bottom:3px!important}.auth-card .auth-logo{margin-bottom:14px!important}.auth-card .auth-close{width:28px!important;height:28px!important;font-size:14px!important}}
        @media(max-width:768px){.main-nav{padding:0 20px!important;height:52px!important}.nav-links{display:none!important}.nav-login{display:inline-flex!important}.hero-split{padding:24px 20px 20px;gap:20px}.hero-mobile-cta button{padding:16px 48px!important;font-size:16px!important;border-radius:16px!important}.hero-h1{font-size:42px!important}.hero-refined{font-size:48px!important}.hero-sub{font-size:16px!important;margin-bottom:24px!important;max-width:340px!important;margin-left:auto!important;margin-right:auto!important}.hero-badge{font-size:13px!important;margin-bottom:20px!important;padding:5px 16px!important}.hero-stats{gap:32px!important}.hero-stat-val{font-size:22px!important}.hero-stat-icon{font-size:16px!important}.hero-stat-label{font-size:11px!important}.hero-carousel-item{padding:8px 16px!important;font-size:13px!important;border-radius:10px!important;gap:6px!important}.sec{min-height:calc(100dvh - 96px)}.s2-features{grid-template-columns:1fr!important;gap:10px!important}.s2-features .feat{padding:16px 14px!important;border-radius:16px!important}.feat-desc{display:none!important}.feat-row{gap:10px!important;margin-bottom:0!important}.feat-ic{width:36px!important;height:36px!important;min-width:36px!important;min-height:36px!important;border-radius:10px!important;font-size:17px!important}.s2-features .feat h3{font-size:14px!important}.s2-label{display:none!important}.s2-wrap{padding:28px 20px 20px!important}.s2-wrap h2{font-size:24px!important}.s2-wrap h2 .serif{font-size:27px!important}.s2-steps-wrap{padding:20px 20px 28px!important}.s2-steps-wrap h2{font-size:20px!important}.s2-steps{display:flex!important;flex-direction:row!important;gap:8px!important;grid-template-columns:none!important}.s2-step{flex:1!important;padding:18px 6px 16px!important;text-align:center!important;flex-direction:column!important;background:${t.surface}!important;border:1px solid ${t.surfaceBrd}!important;border-radius:14px!important;backdrop-filter:blur(12px)!important}.s2-step-icon{width:auto!important;height:auto!important;border-radius:0!important;margin-bottom:6px!important;background:none!important;border:none!important;box-shadow:none!important;transform:none!important;font-size:16px!important}.s2-step-emoji{display:none!important}.s2-step-num{display:inline!important;font-size:16px!important;font-weight:700!important;color:${t.accent}!important}.s2-step-text{display:none!important}.s2-connector{display:none!important}.auth-card{max-width:100%!important;height:520px!important;max-height:none!important;padding:20px 18px!important;border-radius:16px!important}.auth-card h2{font-size:19px!important;margin-bottom:1px!important}.auth-card p{font-size:11px!important;margin-bottom:12px!important}.auth-card input{padding:9px 12px!important;font-size:13px!important;border-radius:10px!important;margin-bottom:6px!important}.auth-card button{font-size:13px!important;padding:11px 0!important;border-radius:10px!important;margin-bottom:8px!important}.auth-card label{font-size:9px!important;margin-bottom:2px!important}.auth-card .auth-logo{margin-bottom:10px!important}.auth-card .auth-logo>div{width:32px!important;height:32px!important}.auth-card .auth-close{width:26px!important;height:26px!important;font-size:13px!important;border-radius:8px!important}}
        @media(max-width:480px){.sec{min-height:calc(100dvh - 92px)}}
      `}</style>

      {/* ═══ NAVBAR ═══ */}
      <nav className="main-nav" style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 36px",height:60,background:dark?"#060810":scrolled?"rgba(139,74,94,.98)":"rgba(163,88,107,.95)",borderBottom:`1px solid ${dark?"rgba(255,255,255,.06)":"rgba(255,255,255,.12)"}`,flexShrink:0,zIndex:100,transition:"background .3s"}}>
      ...
      <div ref={scrollRef} style={{flex:1,overflowY:"auto",overflowX:"hidden",WebkitOverflowScrolling:"touch",scrollBehavior:"smooth"}}>
        ...
        <section id="hero" className="sec" style={{overflow:"hidden",background:t.heroBg}}>
          ...
          <div className="hero-split" style={{flex:1,position:"relative",zIndex:1}}>
            ...
            <div className="hero-left">
              <div className="fu hero-badge" style={{display:"inline-flex",alignItems:"center",gap:8,padding:"6px 18px",borderRadius:24,background:t.heroAccentBadge,border:`1px solid ${dark?"rgba(196,125,142,.15)":"rgba(255,255,255,.3)"}`,fontWeight:550,color:dark?t.accent:"#fff",marginBottom:24,backdropFilter:"blur(8px)"}}>🚀 Trusted by {siteStats.users} creators across Nigeria</div>
              <h1 className="fu fd1 hero-h1" style={{fontWeight:800,lineHeight:1.08,letterSpacing:-1,marginBottom:20,color:t.heroText}}>Social Growth,<br/><span className="serif hero-refined" style={{fontStyle:"italic",fontWeight:400,color:dark?t.accent:"#fff",textShadow:dark?"none":"0 2px 20px rgba(196,125,142,.15)"}}>Refined.</span></h1>
              <p className="fu fd2 hero-sub" style={{color:t.heroSoft,fontWeight:430,maxWidth:440,marginBottom:28,lineHeight:1.65}}>Real followers. Real engagement. Instant delivery. Nigeria's most trusted SMM platform.</p>
              <div className="fu fd3 hero-stats" style={{display:"flex",gap:40,flexWrap:"wrap"}}>
                {[[siteStats.users,"Active Users","👥"],[siteStats.orders,"Orders","📦"],["₦500","Min Deposit","💳"],["24/7","Support","💬"]].map(([v,l,ic])=><div key={l}><div className="hero-stat-icon" style={{marginBottom:3}}>{ic}</div><div className="m hero-stat-val" style={{fontWeight:700,color:t.heroText}}>{v}</div><div className="hero-stat-label" style={{color:t.heroMuted,marginTop:1,fontWeight:450}}>{l}</div></div>)}
              </div>
              ...
              <div className="hero-mobile-cta fu fd4"><button onClick={()=>setModal("signup")} style={{padding:"16px 48px",borderRadius:16,background:"#fff",color:"#1c1b19",fontSize:16,fontWeight:700,boxShadow:"0 8px 28px rgba(0,0,0,.12)",border:"none"}}>Get Started Free →</button></div>
            </div>
            ...
            <div className="hero-right">
              <div className="hero-inline-card">
                ...
                {/* Method toggle */}
                <div style={{display:"flex",marginBottom:16,background:dark?"rgba(255,255,255,0.04)":"rgba(0,0,0,0.03)",borderRadius:10,padding:3,border:`1px solid ${dark?"rgba(255,255,255,.06)":"rgba(0,0,0,.06)"}`}}><button onClick={()=>{}} style={{flex:1,padding:"8px 0",borderRadius:8,fontSize:13,fontWeight:550,background:t.accentLight,color:t.accent}}>Email</button><button onClick={()=>{}} style={{flex:1,padding:"8px 0",borderRadius:8,fontSize:13,fontWeight:550,background:"transparent",color:t.textMuted}}>Phone</button></div>
        ...
        <section id="services" style={{minHeight:"calc(100dvh - 100px)",display:"flex",flexDirection:"column",position:"relative",background:dark?"rgba(255,255,255,.015)":"rgba(0,0,0,.012)",overflow:"hidden"}}>
