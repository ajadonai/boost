...
export default function AdminLogin(){
  ...
  return (
    <div className="admin-root" style={{minHeight:"100dvh",background:t.heroBg,display:"flex",flexDirection:"column",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"}}>
        ...
        {[["12%","15%",4,0],["20%","75%",3,1],["65%","10%",3,.5],["55%","85%",5,1.5],["40%","92%",3,2],["80%","40%",4,.8]].map(([top,left,s,d],i)=><div key={i} style={{position:"absolute",top,left,width:s,height:s,borderRadius:"50%",background:dark?"rgba(196,125,142,.2)":"rgba(255,255,255,.2)",animation:`float3 ${3.5+i*.5}s ease-in-out infinite ${d}s`}}/>)}
      </div>

      {/* Nav */}
      <nav className="admin-nav" style={{display:"flex",alignItems:"center",justifyContent:"space-between",height:60,flexShrink:0,zIndex:10,borderBottom:`1px solid ${dark?"rgba(255,255,255,.06)":"rgba(255,255,255,.12)"}`}}>
