...
function ActivityLog({t,dark,activity,role,adminName}){
  ...
  return <div><Hdr title="Activity Log" sub={`${baseActivity.length} ${canSeeAll?"logged actions":"of your actions"}`} t={t}/>
    <input placeholder="Search actions..." value={q} onChange={e=>{setQ(e.target.value);setPage(1);}} style={{width:"100%",maxWidth:400,padding:"10px 14px",borderRadius:10,background:t.inputBg,border:`1px solid ${t.inputBorder}`,color:t.text,fontSize:13,marginBottom:12,outline:"none"}}/>
