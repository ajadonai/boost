          ...
          <>
            ...
            <div className="rounded-xl p-4 mb-2.5" style={{ background: dark ? "rgba(255,255,255,.06)" : "rgba(255,255,255,.85)", border: `0.5px solid ${t.cardBorder}` }}>
              ...
              {gateways.length > 0 ? (
                ...
                <select disabled className="w-full py-2.5 px-3.5 rounded-[10px] text-sm outline-none appearance-none" style={{ background: dark ? "rgba(255,255,255,.08)" : "#fff", border: `1px solid ${dark ? "rgba(255,255,255,.14)" : "rgba(0,0,0,.18)"}`, color: t.textMuted, fontFamily: "'Outfit',sans-serif" }}>
