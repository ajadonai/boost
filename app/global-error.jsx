    ...
    <html>
      <body style={{ fontFamily: "'Outfit', sans-serif", background: "#080b14", color: "#f0ede8", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", margin: 0, padding: 20 }}>
        <div style={{ textAlign: "center", maxWidth: 400 }}>
          ...
          <button
            onClick={() => reset()}
            style={{ padding: "12px 28px", borderRadius: 10, background: "linear-gradient(135deg,#c47d8e,#8b5e6b)", color: "#fff", fontSize: 14, fontWeight: 600, border: "none", cursor: "pointer" }}
          >
            Try Again
          </button>
          <div style={{ marginTop: 16 }}>
            <a href="/" style={{ fontSize: 13, color: "#c47d8e", textDecoration: "none" }}>← Back to home</a>
          </div>
        </div>
      </body>
    </html>
