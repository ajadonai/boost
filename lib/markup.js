 ...
 * @param {string} tier - "Budget" | "Standard" | "Premium" (unused in bracket system, kept for API compat)
...
export function calculateTierPrice(costPer1k, tier, settings = {}, nigerian = false) {
  ...
  // Brackets are defined in NGN (e.g., 0-20 means ₦0-₦20 = 0-2000 kobo)
...
export { DEFAULT_BRACKETS, DEFAULT_USD_RATE };
